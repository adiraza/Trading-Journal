  ...
  const fetchTrades = async () => {
    try {
      ...
      const transformedTrades = data?.map(trade => ({
        ...
        exitDayName: trade.exit_day_name,
        exitSession: trade.exit_session,
        exitPrice: null,
        exitReason: trade.exit_reason,
        profitLoss: trade.profit_loss,
        profitLossPercent: trade.profit_loss_percent,
        riskPercentActual: trade.risk_percent_actual,
        rr: trade.rr,
        roi: trade.roi,
  ...
  const getTrade = async (id: string) => {
    try {
      ...
      return {
        ...
        exitDayName: data.exit_day_name,
        exitSession: data.exit_session,
        exitPrice: null,
        exitReason: data.exit_reason,
        profitLoss: data.profit_loss,
        profitLossPercent: data.profit_loss_percent,
        riskPercentActual: data.risk_percent_actual,
        rr: data.rr,
        roi: data.roi,
        netPnl: data.net_pnl,
        exitNotes: data.exit_notes,
        beforeEntryImages: [],
        afterExitImages: [],
